package 
{
	...
	public class panel_1 extends MovieClip
	{
		...
		private var urlRequest:URLRequest = new URLRequest("http://www.mmbusinessstages.com/Home.aspx?key=254BD7DD-FD61-41BE-90B3-EF40B0FF0331");
		private var xmlLoader:URLLoader = new URLLoader();

		private var lineColorTransform:ColorTransform = new ColorTransform  ;
		private var btnBgColorTransform:ColorTransform = new ColorTransform  ;
		private var btnOverColorTransform:ColorTransform = new ColorTransform  ;
		...
		public function init()
		{
			...
			xmlLoader.load(new URLRequest("xml/data1.xml"));
		...
		function ButtonClick(event:MouseEvent):void
		{
			...
			{
				trace("fs");
				fscommand("exec","SB10072_1115LR.exe");
				//holder.visible = false;
			}
			if (event.currentTarget.p == "fs1")
			{
				trace("fs1");
				fscommand("exec","SB10214.exe");
				//holder.visible = false;
			}
			if (event.currentTarget.p == "fs2")
			{
				trace("fs2");
				fscommand("exec","Li8502.exe");
				brOut.visible = false;
				brOver.visible = true;
			}
			if (event.currentTarget.p == "fs3")
			...
			{
				trace("fs4");
				fscommand("exec","rs3116.exe");
				//holder.visible = false;
			}

			if (event.currentTarget.p == "fs5")
			{
				trace("fs5, Genuine_Interactive");
			...
			{
				trace("fs5");
				fscommand("exec","SB10068_032411MR.exe");
				//holder.visible = false;
			}
			...
			{
				trace("fs5");
				fscommand("exec","SB10225.exe");
				//holder.visible = false;
			}

			if (event.currentTarget.p == "fs9")
			{
				trace("fs5");
				fscommand("exec","SB10226.exe");
				//holder.visible = false;
			}
			...
			{
				trace("fs5");
				fscommand("exec","SB10227.exe");
				//holder.visible = false;
			}

			if (event.currentTarget.p == "fs11")
			{
				trace("fs5");
				fscommand("exec","SB10230.exe");
				//holder.visible = false;
			}
		}
		// progress
