package 
{
	...
	public class panel_2 extends MovieClip
	{
		...
		//private var header:Sprite = new Header();
		...
		public function init()
		{
			...
			xmlLoader.load(new URLRequest("xml/data2.xml"));
		...
		function ButtonClick(event:MouseEvent):void
		{
			...
			{
				trace("fs");
				fscommand("exec","SB10215_051914_Fillable.exe");
				
			}
			if (event.currentTarget.p == "fs1")
			{
				trace("fs1");
				fscommand("exec","SB10217_062514LR.exe");
				
			}
			if (event.currentTarget.p == "fs2")
			{
				trace("fs2");
				fscommand("exec","SB10219.exe");
			...
			{
				trace("fs4");
				fscommand("exec","AS8017_IBETE.exe");
