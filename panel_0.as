package 
{
	...
	public class panel_0 extends MovieClip
	{
		...
		function ButtonClick(event:MouseEvent):void
		{
			...
			{
				trace("fs");
				fscommand("exec","SB10107.exe");

			}
			if (event.currentTarget.p == "fs1")
			{
				trace("fs1");
				fscommand("exec","SB10104f.exe");

			}
			if (event.currentTarget.p == "fs2")
			{
				trace("fs2");
				fscommand("exec","down_to_bus.exe");

			}
			if (event.currentTarget.p == "fs3")
			{
				trace("fs3");
				fscommand("exec","SB10203_080312.exe");

			}
			if (event.currentTarget.p == "fs4")
			{
				trace("fs4");
				fscommand("exec","SB10206.exe");

			}
			if (event.currentTarget.p == "fs5")
			{
				trace("fs5");
				fscommand("exec", "FLVPlaybackPro6.exe");
